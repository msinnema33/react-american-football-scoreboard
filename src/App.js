...
function App() {
    ...
    let [visScore, setVisScore] = useState(0);
    return ( <
        ...
        div className = "away__score" > { visScore } < /div> <
        /div> <
        /div> <
        BottomRow / >
        <
        ...
        button onClick = { event => setHomeScore(homeScore + 7) }
        className = "homeButtons__touchdown" > Home Touchdown < /button> <
        button onClick = { event => setHomeScore(homeScore + 3) }
        className = "homeButtons__fieldGoal" > Home Field Goal < /button> <
        /div> <
        div className = "awayButtons" >
        <
        button onClick = { event => setVisScore(visScore + 7) }
        className = "awayButtons__touchdown" > Away Touchdown < /button> <
        button onClick = { event => setVisScore(visScore + 3) }
